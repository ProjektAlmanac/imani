...
interface LoginApi {
    ...
    @Operation(
        ...
        responses = [
            ...
            ApiResponse(responseCode = "401", description = "Datos incorrectos", content = [Content(schema = Schema(implementation = ProblemDetailsDto::class))])
        ]
    )
    @RequestMapping(
    ...
    fun login(@Parameter(description = "") @Valid @RequestBody(required = false) loginDto: LoginDto?): ResponseEntity<UsuarioDto>
}
